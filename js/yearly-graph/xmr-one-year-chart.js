// XMR 360 days chart
var url = "https://min-api.cryptocompare.com/data/histoday?fsym=XMR&tsym=USD&limit=366&aggregate=3&e=CCCAGG";
...
var url = "https://min-api.cryptocompare.com/data/pricemulti?fsyms=BTC,xmr,EOS,BCH,LTC,XRP,XMR&tsyms=USD";
var urlHistoricalBtc = "https://min-api.cryptocompare.com/data/histominute?fsym=XMR&tsym=USD&limit=1";
...
function parseJsonFromCryptoCompare(json) {
    ...
    var xmrereum = json["XMR"]["USD"];

    document.getElementById("xmrLast").innerHTML = xmrereum;
    document.getElementById("lastUpdated").innerHTML = time;

    colorText("xmrLast", urlHistoricalBtc);
...
(function getData() {
    var url = "https://min-api.cryptocompare.com/data/pricemultifull?fsyms=XMR&tsyms=USD";
    url = encodeURI(url);
    console.log(url);

    $.getJSON(url, function(data) {

            var hxmr_crypto_data = '';
            var lxmr_crypto_data = '';
            var pcxmr_crypto_data = '';
            var mcxmr_crypto_data = '';
            ...
            $('#xmrHigh').html(hxmr_crypto_data);
            $('#xmrLow').html(lxmr_crypto_data);
            $('#xmrPct').html(pcxmr_crypto_data);
            $('#xmrMkc').html(mcxmr_crypto_data);
