...
// ETH 365 days 
var url = "https://min-api.cryptocompare.com/data/histoday?fsym=OKB&tsym=USD&limit=365&aggregate=1&e=CCCAGG";
...
d3.json(url).get(function(error, d) {
    ...
    */
    ...
    monthlyBubbleChart
        ...
        .xAxisLabel('OKB Gain $') // (optional) render an axis label below the x axis
        .yAxisLabel('OKB Gain %') // (optional) render a vertical axis lable left of the y axis
