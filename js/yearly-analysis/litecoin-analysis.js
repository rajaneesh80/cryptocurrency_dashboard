...
d3.json(url).get(function(error, d) {
    ...
    */
    ...
    monthlyBubbleChart
        ...
        .xAxisLabel('Lite-Coin Gain $') // (optional) render an axis label below the x axis
        .yAxisLabel('Lite-Coin Gain %') // (optional) render a vertical axis lable left of the y axis
